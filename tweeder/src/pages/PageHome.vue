        ...
        <div class="col">
          ...
          >
            <template v-slot:before>
              <q-avatar size="xl">
                <img src="https://w7.pngwing.com/pngs/33/65/png-transparent-computer-icons-user-social-media-male-female-symbol-apartment-head-social-media-thumbnail.png">
              </q-avatar>
            </template>
          </q-input>
        </div>
